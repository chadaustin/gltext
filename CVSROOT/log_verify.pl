#!/usr/local/bin/perl
#
# $Id: log_verify.pl,v 1.1 2002-06-06 01:03:13 nonchocoboy Exp $
...
my $CVSROOT = $ENV{'CVSROOT'} || "/cvsroot/gltext";
...
sub cleanup_lockfiles {
    print "Cleaning up garbage CVS locks in $CVSROOT...\n";
